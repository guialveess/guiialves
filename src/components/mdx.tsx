...
import { ViteFileTree } from '@/components/ViteFileTree';
...
export const components = {
  ...
  h2: ({ children, ...props }: HeadingProps) => (
    <h2 className="text-3xl font-bold py-8 text-gray-900 dark:text-gray-100" {...props}>
      {children}
    </h2>
  ),
  ...
  p: ({ children, ...props }: ParagraphProps) => (
    <p className="leading-snug text-gray-900 py-8 dark:text-gray-100" {...props}>
      {children}
    </p>
  ),
  ol: (props: ListProps) => (
  ...
  Card, ComparisonTable, NextFileTree, ViteFileTree, HeadingWithIcon// Adicionando o Card como componente utilizável no MDX
};
