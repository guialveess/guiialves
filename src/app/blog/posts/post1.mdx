...
<HeadingWithIcon
  ...
  icon={<img src="/nextjs2.svg" alt="Next.js Logo" className="w-10 h-10" />}
/>
...
<Card title="" description="Principais razões para escolher o Next.js:">
...
<Card title="" description="Principais razões para escolher o Vite:">
...
## Estrutura do Projeto SaaS com Next.js
...
<ComparisonTable
  title="Diferenças entre Next.js e Vite"
  data={[
...
<Card title="Resumo: Quando escolher cada ferramenta" description="">
